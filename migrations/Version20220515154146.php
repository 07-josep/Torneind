 ...
 */
final class Version20220515154146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE torneo ADD codigo VARCHAR(255) NOT NULL');
    }
