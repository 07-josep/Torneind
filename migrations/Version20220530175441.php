 ...
 */
final class Version20220530175441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE torneo ADD ganador VARCHAR(255) DEFAULT NULL');
    }
