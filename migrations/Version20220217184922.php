 ...
 */
final class Version20220217184922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mensaje ADD fecha DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mensaje DROP fecha, CHANGE mensaje mensaje VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
