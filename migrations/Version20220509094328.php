 ...
 */
final class Version20220509094328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE cuentasony cuenta_sony VARCHAR(255) DEFAULT NULL');
    }
